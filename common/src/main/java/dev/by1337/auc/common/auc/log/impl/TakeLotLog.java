...
public class TakeLotLog implements AuctionLog, WithItemStackLog, WithLPriceLog {
    public static final String ID = "native:take_lot";
    ...
    public TakeLotLog(long timestamp, UUID who, long lprice, int item, int count) {
