...
public class AddonClassLoader extends URLClassLoader {
    ...
    public AddonClassLoader(@Nullable ClassLoader parent, File file, AddonLoader loader, BAuction plugin) throws Exception {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                if (clazz.isAnnotationPresent(BAucAddon.class)) {
                    BAucAddon a = clazz.getAnnotation(BAucAddon.class);
    ...
    void initialize(AbstractAddon addon) {
        addon.init(LoggerFactory.getLogger(description.name()), description, this, file, plugin);
    }
