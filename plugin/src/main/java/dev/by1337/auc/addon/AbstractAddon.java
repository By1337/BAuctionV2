...
public abstract class AbstractAddon extends AucLifecycle {
    private Logger logger;
    private boolean isEnabled = false;
    private AddonDescription description;
    private ClassLoader classLoader;
    private File file;
    private BAuction plugin;
    ...
    void init(Logger logger, AddonDescription description, ClassLoader classLoader, File file, BAuction server) {
        this.logger = logger;
